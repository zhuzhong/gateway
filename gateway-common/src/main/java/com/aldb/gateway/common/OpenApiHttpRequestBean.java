...
public class OpenApiHttpRequestBean {
    ...
    private Map<String, String> reqHeader;// ����ͷ

    private String operationType;// �ڲ���������

    private String clientAddr; // �ͻ���ip
    private String localAddr;// �����ip
    private int localPort;// ����˿�

    private Map<String, String> thdApiUrlParams;// ����ӿ����贫���url����
    private String serviceReqData; // post���󷽷�����
    private String requestMethod;
    /**
     * �������в����������ظ��ģ�Ϊ�˺�����õķ������������ˡ�queryString����ʵ���ϲ���Ҫ
     */
    private Map<String, String> serviceGetReqData; // get�������
    private String queryString; // get����string

    private Date requestTime; // ����ʱ��
    private Date responseTime;// ��Ӧʱ��
    private Long elapsedTime;// ��ʱ

    private String traceId; // �ڲ����������id

    private String printStr; // ��Ӧ���������д��response������
